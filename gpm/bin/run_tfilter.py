...
def main():
    ...
    parser.add_argument('--project', default="gpm2024", help="The project name to assign to the candidates being uploaded. For this pipeline, this could be, e.g., 'gpm2024' (default = 'gpm2024')")
